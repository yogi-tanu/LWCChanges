...
function toArray(value) {
  ...
  return slice.call ? slice.call(value) : Array.from(value);
}
/**
...
var render = {
  ...
  initContainer: function initContainer() {
    ...
    var containerData = {
      ...
      // height: Math.max(element.offsetHeight, minHeight >= 0 ? minHeight : MIN_CONTAINER_HEIGHT)
    };
  ...
  renderImage: function renderImage(changed) {
    ...
    var height =
      imageData.naturalHeight * (canvasData.height / canvasData.naturalHeight);
    assign(imageData, {
      width: width,
      height: height,
